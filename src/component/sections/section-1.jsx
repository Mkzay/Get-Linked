export default function Section1() {
  return (
    <section className="flex items-center justify-center flex-col mt-7 pb-16 border-b border-white w-full">
      <div>
        <img src="./images/the-big-idea-1.png" />
      </div>
      <div className="flex items-center justify-center flex-col pt-[58px]">
        ...
        <p className="text-center text-white text-xs/[27.5px] font-normal w-80">
