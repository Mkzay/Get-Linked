export default function Section3() {
  return (
    <section className="flex items-center justify-center flex-col mt-[74px] pb-12 border-b border-white w-full">
      <div>
        <img src="./images/peeps.png" />
      </div>
      <div className="flex items-center justify-center flex-col pt-2 gap-4">
        <h2 className="flex items-center flex-col text-xl font-bold text-white">
          Judging Criteria
          <span className="text-first-3">Key attributes</span>
        </h2>
        <p className="text-center text-white text-[13px]/[22.555px] font-normal w-80">
